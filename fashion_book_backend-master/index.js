...
// Connect with mongodb in local: mongodb://localhost:27017 and name of database is fashion_book_db:
mongoose.connect('mongodb://localhost:27017/fashion_book_db', { useNewUrlParser: true, useUnifiedTopology: true });
